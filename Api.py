...
# Non-veg ingredients to exclude when Vegetarian filter is active
...
def init_db():
    ...
    # ── CHANGE 1 of 3 ──────────────────────────────────────────────
    # Added bio TEXT and avatar TEXT columns to the profile table.
    # The rest of the table definition is identical to your original.
    cursor.execute("""
...
def get_profile():
    ...
    if row:
        # ── CHANGE 2 of 3 ──────────────────────────────────────────
        # Added "bio" and "avatar" to the returned JSON.
...
def save_profile():
    ...
    # ── CHANGE 3 of 3 ──────────────────────────────────────────────
    # Added bio and avatar to the INSERT and ON CONFLICT UPDATE.
    # Everything else is identical to your original.
    conn.execute("""
        INSERT INTO profile (
